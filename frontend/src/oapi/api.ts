...
export const DefaultApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        statisticsAPIGet: async (period: StatisticsAPIGetPeriodEnum, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const DefaultApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async statisticsAPIGet(period: StatisticsAPIGetPeriodEnum, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<PeriodStatistics>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.statisticsAPIGet(period, options);
...
export const DefaultApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        statisticsAPIGet(period: StatisticsAPIGetPeriodEnum, options?: RawAxiosRequestConfig): AxiosPromise<PeriodStatistics> {
            return localVarFp.statisticsAPIGet(period, options).then((request) => request(axios, basePath));
        },
        /**
         * ビデオ作成
         * @param {VideoCreate} videoCreate 
...
export class DefaultApi extends BaseAPI {
     ...
     * @memberof DefaultApi
     */
    public statisticsAPIGet(period: StatisticsAPIGetPeriodEnum, options?: RawAxiosRequestConfig) {
        return DefaultApiFp(this.configuration).statisticsAPIGet(period, options).then((request) => request(this.axios, this.basePath));
    }
